...
class Table {
 ...
 private:
   ...
   ListType* data; // decl for array of pointers to Node
   
   // Go through all the data and find the number of non-empty buckets.
   int numNonEmpty() const;

   // Go through all the data and find the length of longest chain
